...
- **Tracked changes**: Use `<w:del>` and `<w:ins>` tags with `w:author="Author"` outside `<w:r>` elements
...
### Validation Rules
The validator checks that the document text matches the original after reverting the author's changes. This means:
...
**Text Insertion:**
```xml
<w:ins w:id="1" w:author="Author" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
**Text Deletion:**
```xml
<w:del w:id="2" w:author="Author" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
