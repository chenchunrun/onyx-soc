...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Author", initials: str = "A"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Author")
            initials: Author initials (default: "A")
        """
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Author")
            initials: Default author initials for comments (default: "A")
        """
