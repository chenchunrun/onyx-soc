...
python knowledge-base/build_threat_intel_archive_worklist.py --batch-id phase-1-cisa-limited-historical --write-report
python knowledge-base/build_threat_intel_archive_patch_preview.py --batch-id phase-1-cisa-limited-historical --write-report
